          ...
          <div css={imgContainer}>
            ...
            <div css={item(false)}>
              ...
              <div css={contentBox(false)}>
                ...
                <p>
                  合理的价格！众所周知，胰岛素泵初期的费用相当昂贵。购买胰岛素泵的费用较贵，在使用过程中会有维护成本，包括用泵输注的速效胰岛素和耗材、电池等。但除此之外，您不需要额外的吃药或打胰岛素笔。因为吃药或注射胰岛素时血糖控制不好，有过数次住院经历的人会知道这有多累，治疗费也高。
                </p>
              </div>
            </div>
            <div css={item(true)}>
